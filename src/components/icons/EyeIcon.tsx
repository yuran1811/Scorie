import { LazyMotion, SVGMotionProps, domAnimation, m } from 'framer-motion';
...
export const EyeIcon: FC<EyeIconProps & SVGMotionProps<SVGSVGElement>> = ({ reveal = false, fill, ...props }) => (
  <LazyMotion features={domAnimation} strict>
    <m.svg {...props} viewBox="0 0 72 72">
      <path
        fill="none"
        stroke="#575cba"
        strokeLinecap="round"
      ...
      />
      <circle cx="34.400002" cy="36" r="6" fill="#575cba" strokeLinecap="round" strokeWidth="4.65066" />
      <m.path
        initial={{
      ...
      >
        ...
        />
        <path fill="none" stroke="#575cba" strokeLinecap="butt" strokeWidth="4.5" d="M 34.602,12.600574 V 23.601076" />
        <path
          fill="none"
          stroke="#575cba"
          strokeLinecap="butt"
