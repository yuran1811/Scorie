...
export const SelectValueContainer = (props: ValueContainerProps<Option, false>) => (
  <components.ValueContainer
    {...props}
    className="!flex !items-center !justify-start w-full !p-0 !px-8 text-white"
  />
);
...
export const SelectSingleValue = ({ children, ...otherProps }: SingleValueProps<Option, false>) => (
  <components.SingleValue
    {...otherProps}
    className="absolute left-0 !w-full !p-0 !px-8 !text-white !text-center"
  >
    {children}
  </components.SingleValue>
);
...
export const SelectMenuList = ({ children, ...otherProps }: MenuListProps<Option, false>) => (
  <components.MenuList
    {...otherProps}
    className="!overflow-y-auto !flex !items-center !justify-center !flex-wrap"
  >
    {children}
  </components.MenuList>
);
