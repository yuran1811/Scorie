	...
	return (
		<div className={`${className || ''} transition-all duration-300 relative top-0 left-0 px-12 py-4 w-[100vw]`}>
			...
			<div className='w-full pt-8'>
				<div className='font-bold text-[3.5rem] text-center w-full line-clamp-1'>Welcome,</div>
				<div className='font-bold text-[5rem] text-center w-full line-clamp-1'>{auth.isAuth ? auth.name : 'Guest'}!</div>
			</div>
