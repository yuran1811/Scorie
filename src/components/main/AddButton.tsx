...
export const AddButton: FC = () => {
	...
	return (
		<>
			<div
				className='z-[10] cursor-pointer flexcenter fixed desktop:right-[10rem] desktop:bottom-[7rem] right-[5rem] bottom-[10rem] w-[7rem] h-[7rem] rounded-[50%] border-[0.5rem] border-indigo-200 bg-ctbg'
